      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center">
            <button className="bg-amber-400 hover:bg-amber-500 text-gray-900 font-inter font-medium px-6 py-2 rounded-lg text-sm transition-colors duration-200">
              Join Now
            </button>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 shadow-sm">
          <div className="px-4 pt-4 pb-4 space-y-2">
            ...
            <button className="w-full bg-amber-400 hover:bg-amber-500 text-gray-900 font-inter font-medium px-6 py-2 rounded-lg text-sm mt-2 transition-colors duration-200">
              Join Now
            </button>
          </div>
        </div>
